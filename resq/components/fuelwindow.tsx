...
export default function FuelWindow() {
  const router = useRouter();

  // CONSTANTS
  const SERVICE_NAME = "Fuel Delivery";
  const PRICE = 199;

  // HANDLE FIRESTORE REQUEST
  const handleRequest = async () => {
    try {
      ...
      alert("Fuel delivery requested successfully!");
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Image
          source={{
            uri: "https://stampedeauto.com/img/Restart-Car-Run-Out-Gas-min-1.webp",
          }}
        ...
        <View style={styles.infoCard}>
          ...
          <Text style={styles.description}>
            Ran out of fuel in the middle of the road?  
            We deliver petrol or diesel quickly and safely to your location.
          </Text>
        </View>

        {/* HIGHLIGHT BOX */}
        <View style={styles.highlightBox}>
          <Ionicons name="flash-outline" size={28} color="#4DB7FF" />
          <View style={{ marginLeft: 12 }}>
            <Text style={styles.highlightTitle}>What’s Included</Text>
            <Text style={styles.highlightText}>• Fuel delivery to your location</Text>
            <Text style={styles.highlightText}>• Basic fuel system check</Text>
            <Text style={styles.highlightText}>• Safe pouring assistance</Text>
          </View>
        </View>
        ...
        <View style={styles.priceCard}>
          ...
          <View style={{ alignItems: "flex-end" }}>
            ...
            <Text style={styles.gstText}>+ Fuel Cost</Text>
          </View>
        </View>

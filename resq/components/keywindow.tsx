...
export default function KeyWindow() {
  ...
  // CONSTANTS
  const SERVICE_NAME = "Key Recovery";
  const PRICE = 249;
  ...
  const handleRequest = async () => {
    try {
      ...
      alert("Key recovery service requested successfully!");
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Image
          source={{
            uri: "https://www.montyslocksmith.ca/wp-content/uploads/2025/04/Wordpress-Blogs-Images-20.png",
          }}
        ...
        <View style={styles.infoCard}>
          ...
          <Text style={styles.description}>
            ...
            Our expert locksmiths can safely retrieve keys without damaging your vehicle.
          </Text>
        </View>

        {/* HIGHLIGHT BOX */}
        <View style={styles.highlightBox}>
          <Ionicons name="key-outline" size={28} color="#4DB7FF" />
          <View style={{ marginLeft: 12 }}>
            <Text style={styles.highlightTitle}>Includes</Text>
            <Text style={styles.highlightText}>• Safe key retrieval</Text>
            <Text style={styles.highlightText}>• Door unlocking assistance</Text>
            <Text style={styles.highlightText}>• No body damage</Text>
          </View>
        </View>

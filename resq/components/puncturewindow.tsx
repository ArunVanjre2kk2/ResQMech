...
export default function PunctureWindow() {
  const router = useRouter();
  // CONSTANTS
  const SERVICE_NAME = "Puncture Repair";
  const PRICE = 149;
  ...
  const handleRequest = async () => {
    try {
      ...
      alert("Puncture repair requested successfully!");
    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.headerRow}>
          ...
          <Text style={styles.headerTitle}>Puncture Fix</Text>
        </View>

        {/* IMAGE */}
        <Image
          source={{
            uri: "https://images.unsplash.com/photo-1607864413043-fd8e13fca2d1",
          }}
        ...
        <View style={styles.infoCard}>
          ...
          <Text style={styles.description}>
            Professional puncture repair delivered directly to your location.
            Quick, efficient service with guaranteed safety checks.
          </Text>
        </View>
        ...
        <View style={styles.highlightBox}>
          ...
          <View style={{ marginLeft: 12 }}>
            <Text style={styles.highlightTitle}>Includes</Text>

            <Text style={styles.highlightText}>• Tyre inspection</Text>
            <Text style={styles.highlightText}>• Nail removal</Text>
            <Text style={styles.highlightText}>• Puncture patching</Text>
            <Text style={styles.highlightText}>• Air pressure correction</Text>
          </View>
        </View>
